    ...
    <div className="relative w-80 h-80 flex items-center justify-center">
      ...
      >
        ...
        <path
          ...
          opacity="0.5"
        />
        <circle cx="65" cy="90" r="3" fill="none" stroke="#FFFFFF" strokeWidth="1.5" />
        <circle cx="65" cy="90" r="1.5" fill="#FFFFFF" />
        ...
        <path
          ...
          opacity="0.5"
        />
        <circle cx="335" cy="90" r="3" fill="none" stroke="#FFFFFF" strokeWidth="1.5" />
        <circle cx="335" cy="90" r="1.5" fill="#FFFFFF" />
        ...
        <line x1="140" y1="295" x2="260" y2="295" stroke="#FFFFFF" strokeWidth="1.5" />
        <line x1="145" y1="305" x2="255" y2="305" stroke="#FFFFFF" strokeWidth="1.5" />
        <line x1="150" y1="315" x2="250" y2="315" stroke="#FFFFFF" strokeWidth="1.5" />
        <line x1="155" y1="325" x2="245" y2="325" stroke="#FFFFFF" strokeWidth="1.5" />

        {/* Вертикальные разделители вентиляционных отверстий */}
        <line x1="170" y1="290" x2="170" y2="330" stroke="#FFFFFF" strokeWidth="0.8" opacity="0.6" />
        <line x1="200" y1="290" x2="200" y2="335" stroke="#FFFFFF" strokeWidth="0.8" opacity="0.6" />
        <line x1="230" y1="290" x2="230" y2="330" stroke="#FFFFFF" strokeWidth="0.8" opacity="0.6" />
        ...
        <circle cx="250" cy="120" r="2" fill="#FFFFFF" />
        <circle cx="110" cy="200" r="2" fill="#FFFFFF" />
        <circle cx="290" cy="200" r="2" fill="#FFFFFF" />
        ...
        <line x1="200" y1="75" x2="200" y2="130" stroke="#FFFFFF" strokeWidth="0.8" opacity="0.5" />
