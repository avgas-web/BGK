...
// 27 мужских имён операторов (20 старославянских + 7 обычных)
const maleOperators = [
  ...
  'Александр', 'Дмитрий', 'Сергей', 'Андрей', 'Михаил', 'Иван', 'Николай'
];

// 20 женских имён операторов (10 обычных + 10 старославянских/дурацких)
const femaleOperators = [
  'Марина', 'Светлана', 'Елена', 'Ольга', 'Татьяна',
  'Наталья', 'Ирина', 'Анна', 'Мария', 'Екатерина',
  'Ефросинья', 'Фекла', 'Прасковья', 'Агафья', 'Лукия',
  'Устинья', 'Соломонида', 'Пелагея', 'Домника', 'Капитолина'
];

// Объединяем всех операторов
const operatorNames = [...maleOperators, ...femaleOperators];
